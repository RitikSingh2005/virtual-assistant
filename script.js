...
function takeCommand(message){
   voice.style.display="none"
    ...
    if(message.includes("hello")||message.includes("hey")){
        ...
        speak("i am jarvis your virtual assistant ,created by Ritik Sir")
      ...
      speak(time)
        ...
        let finalText="this is what i found on internet regarding" + message.replace("jarvis","") || message.replace("jarvish","")
        speak(finalText)
